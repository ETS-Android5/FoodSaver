...
public class RotaTask extends AsyncTask<Void, Integer, Boolean> {
    ...
    private final ArrayList<LatLng>
            lstLatLng = new ArrayList<LatLng>();
    ...
    @Override protected Boolean doInBackground(Void... params)
    {
        try {
            ...
            url.append("&key=AIzaSyB1u4rKQUeSTrY_a88L7zDEt77FU92oO0s");
            ...
            final int length = nodeListStep.getLength(); for(int i = 0; i<length; i++)
            {
